...
class ViewController: UIViewController {
    ...
    lazy var bannerImagesURLS = {
        InitialInfoRetriever.bannerImagesURLs(numberOfImages: self.info.bannersLength)
    }
    ...
    var promotionTableViewCell: PromotionTableViewCell? {
        ...
        cell.bannerImageView.sd_setImage(with: self.bannerImagesURLS()[self.bannerImageIndex % self.info.bannersLength], completed: nil)
